                ...
                if ($result) {
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                <a href='alterar_reserva.php?id=" . $row["id"] . "' class='text-blue-500 mr-2'><i class='fas fa-edit'></i> Alterar</a>
                <a href='excluir_reserva.php?id=" . $row["id"] . "' class='text-red-500'><i class='fas fa-trash'></i> Excluir</a>
            </td>";
                            echo "</tr>";
                        }
                    } else {
